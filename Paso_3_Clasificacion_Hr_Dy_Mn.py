...
engine_Flag_Manual = create_engine('postgresql://postgres:vag@10.30.19.5:5432/GAWUSH_PROCESADOS')
...
if __name__ == '__main__':
    ...
    axes.set_xlim([inicio, fin])
    plt.plot(O3_Mo.index, O3_Mo.O3, linestyle='-', marker='.', ms=20, c='tab:green')
    plt.plot(O3_Dy.loc[O3_Dy.F == 0].index, O3_Dy.O3.loc[O3_Dy.F == 0], marker='.', ms=10, c='tab:blue')
    plt.scatter(O3_Dy.loc[O3_Dy.F == 1].index, O3_Dy.O3.loc[O3_Dy.F == 1], c='red')

    axes = plt.subplot(313)
    axes.set_title('O3 [ppb] Mensual')
    axes.set_xlim([inicio, fin])
    axes.set_ylim([0, 40])
    plt.plot(O3_Dy.loc[O3_Dy.F == 0].index, O3_Dy.O3.loc[O3_Dy.F == 0], linestyle='-', marker='.', ms=10, c='tab:green')
    plt.plot(O3_Paso_3.loc[O3_Paso_3.F == 0].index, O3_Paso_3.O3.loc[O3_Paso_3.F == 0], linestyle='-', marker='.', ms=3, c='tab:blue')
    plt.scatter(O3_Paso_3.loc[O3_Paso_3.F == 1].index, O3_Paso_3.O3.loc[O3_Paso_3.F == 1], c='red')
